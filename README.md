...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create marram-remix-app-0218
  fly apps create marram-remix-app-0218-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app marram-remix-app-0218
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app marram-remix-app-0218-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'marram-remix-app-0218-staging' does not match app name in config file 'marram-remix-app-0218'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name marram-remix-app-0218-db
  fly postgres attach --app marram-remix-app-0218 marram-remix-app-0218-db

  fly postgres create --name marram-remix-app-0218-staging-db
  fly postgres attach --app marram-remix-app-0218-staging marram-remix-app-0218-staging-db
  ```
